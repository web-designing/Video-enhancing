...
:fire: Update the **RealESRGAN AnimeVideo-v3** model . Please see [[anime video models](docs/anime_video_model.md)] and [[comparisons](docs/anime_comparisons.md)] for more details.
